...
-  *Evaluating the Effects of Globalisation on Work: A Phenomenological Model of Abstract Evaluations based on Awareness, Learning, and Knowledge*. Research article with Mika Helander.
-  Finnish Emergency Services Attitudes 2023 report with Alisa Puustinen.
-  Modelling affective risk using psychometric networks, with Alisa Puustinen.
-  Book chapter on networks in risk perception, with Jan-Erik Anderson and Alisa Puustinen.
